...
describe('equipment helper', () => {
  ...
  it('should enable sign512Equipment prop for signEquipment on StopPlace based on data', () => {
    ...
    let stopPlace = helpers.update512SignEquipment(unequiptedStopPlace, payLoadTrue)
  ...
  it('should disable sign512Equipment prop for signEquipment on StopPlace based on data', () => {
    ...
    let stopPlace = helpers.update512SignEquipment(equiptedStopPlace, payLoadFalse)
  ...
  it('should enable sign512Equipment prop for signEquipment on Quayx based on data and index', () => {
    ...
    let equiptedWith512 = helpers.get512SignEquipment(unEquiptedWith512Sign.quays[0])
    ...
    let stopPlace = helpers.update512SignEquipment(unEquiptedWith512Sign, payLoadTrue)
