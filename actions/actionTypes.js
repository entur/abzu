...
export const SET_FOCUS_ON_QUAY = 'SET_FOCUS_ON_QUAY'
export const SET_ACTIVE_MAP = 'SET_ACTIVE_MAP'
export const ADDED_JUNCTION_ELEMENT = 'ADDED_JUNCTION_ELEMENT'
export const CHANGED_JUNCTION_POSITION = 'CHANGED_JUNCTION_POSITION'
export const CHANGED_PATH_JUNCTION_NAME = 'CHANGED_PATH_JUNCTION_NAME'
export const CHANGED_ENTRANCE_NAME = 'CHANGED_ENTRANCE_NAME'
export const CHANGED_ENTRANCE_DESCRIPTION = 'CHANGED_ENTRANCE_DESCRIPTION'
export const CHANGED_PATH_JUNCTION_DESCRIPTION = 'CHANGED_PATH_JUNCTION_DESCRIPTION'
...
export const RECEIVED_QUAYS_FOR_NEIGHBOURING_STOP = 'RECEIVED_QUAYS_FOR_NEIGHBOURING_STOP'
